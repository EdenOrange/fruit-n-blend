...
Game.Load.prototype = {
    preload: function() {
        ...
        game.load.image('puzzle_apple_orange_h_drop', 'Assets/Game/Puzzle/Apple/apple11.png');
        game.load.image('puzzle_apple_orange_v_drop', 'Assets/Game/Puzzle/Apple/apple12.png');
        game.load.image('puzzle_grape_brown_h', 'Assets/Game/Puzzle/Grape/grape1.png');
        game.load.image('puzzle_grape_brown_v', 'Assets/Game/Puzzle/Grape/grape2.png');
        game.load.image('puzzle_grape_brown_h_drop', 'Assets/Game/Puzzle/Grape/grape3.png');
        game.load.image('puzzle_grape_brown_v_drop', 'Assets/Game/Puzzle/Grape/grape4.png');
        game.load.image('puzzle_grape_purple_h', 'Assets/Game/Puzzle/Grape/grape5.png');
        game.load.image('puzzle_grape_purple_v', 'Assets/Game/Puzzle/Grape/grape6.png');
        game.load.image('puzzle_grape_purple_h_drop', 'Assets/Game/Puzzle/Grape/grape7.png');
        game.load.image('puzzle_grape_purple_v_drop', 'Assets/Game/Puzzle/Grape/grape8.png');
        game.load.image('puzzle_grape_orange_h', 'Assets/Game/Puzzle/Grape/grape9.png');
        game.load.image('puzzle_grape_orange_v', 'Assets/Game/Puzzle/Grape/grape10.png');
        game.load.image('puzzle_grape_orange_h_drop', 'Assets/Game/Puzzle/Grape/grape11.png');
        game.load.image('puzzle_grape_orange_v_drop', 'Assets/Game/Puzzle/Grape/grape12.png');
        game.load.image('puzzle_pineapple_brown_h', 'Assets/Game/Puzzle/Pineapple/pineapple1.png');
        game.load.image('puzzle_pineapple_brown_v', 'Assets/Game/Puzzle/Pineapple/pineapple2.png');
        game.load.image('puzzle_pineapple_brown_h_drop', 'Assets/Game/Puzzle/Pineapple/pineapple3.png');
        game.load.image('puzzle_pineapple_brown_v_drop', 'Assets/Game/Puzzle/Pineapple/pineapple4.png');
        game.load.image('puzzle_pineapple_purple_h', 'Assets/Game/Puzzle/Pineapple/pineapple5.png');
        game.load.image('puzzle_pineapple_purple_v', 'Assets/Game/Puzzle/Pineapple/pineapple6.png');
        game.load.image('puzzle_pineapple_purple_h_drop', 'Assets/Game/Puzzle/Pineapple/pineapple7.png');
        game.load.image('puzzle_pineapple_purple_v_drop', 'Assets/Game/Puzzle/Pineapple/pineapple8.png');
        game.load.image('puzzle_pineapple_orange_h', 'Assets/Game/Puzzle/Pineapple/pineapple9.png');
        game.load.image('puzzle_pineapple_orange_v', 'Assets/Game/Puzzle/Pineapple/pineapple10.png');
        game.load.image('puzzle_pineapple_orange_h_drop', 'Assets/Game/Puzzle/Pineapple/pineapple11.png');
        game.load.image('puzzle_pineapple_orange_v_drop', 'Assets/Game/Puzzle/Pineapple/pineapple12.png');
